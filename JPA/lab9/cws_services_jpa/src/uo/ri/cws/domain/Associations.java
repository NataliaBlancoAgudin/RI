...
public class Associations {
	...
	static void link(Contract contract, Mechanic mechanic) {
	    contract._setMechanic(mechanic);
	    mechanic._getContracts().add(contract);
	}

	static void unlink(Contract contract, Mechanic mechanic) {
    ...
    public static class Catogorized {

	static void link(Contract contract, ProfessionalGroup group) {
	    contract._setProfessionalGroup(group);
	    group._getContracts().add(contract);
	}

	static void unlink(Contract contract, ProfessionalGroup group) {
	...
	static void unlink(Contract contract, ContractType type) {
	...
	static void unlink(Contract contract, Payroll payroll) {
